      ...
      if (!DataHolder.currentPage) {
        ...
        return (
          <>
            ...
            {DataHolder.filterType === "Answered" && <Answered />}

            {DataHolder.filterType === "AllCustomerListPage" && (
              <AllCustomerListPage />
            )}

            {DataHolder.filterType === "NotChatted" && <NotChatted />}
            ...
            {DataHolder.filterType === "SepratePerPage" && <SepratePerPage />}
...
*/}
      {CurrentUserInfo.LayoutPage.state.constantMsg && (
        <div
          className={
            "alert alert-" +
            (CurrentUserInfo.LayoutPage.state.constantMsgType
              ? CurrentUserInfo.LayoutPage.state.constantMsgType
              : "success")
          }
        >
