...
import {CallValidation, FireValidation, Input} from "../Components/FormInputs";
...
class FormCreatorPage extends Component {
    ...
    render() {
        return (
            <Container>
                    ...
                    <Col>
                        <Card>
                            <Card.Body>
                                <Card.Text>
                                    <Alert variant={'info'}>
                                        <b> دریافت اطلاعات از کاربر با تعریف انواع فرم و استفاده در اتاق چت</b>
                                    ...
                                    <Card.Text>
                                        <Row>
                                            ...
                                            <Col>
                                                ...
                                                <Input value={this.state.Message} type={'textarea'}
                                                       ...
                                                       id={'beforeMsg'}
                                                       name={'متن فرم'} placeholder={'مثال: درصورتی که آفلاین بودیم'}/>
                                            ...
                                            <Col>
                                                <Input value={this.state.Name} type={'text'}
                                                       ...
                                                       parent={this}
                                                       id={'title'}
                                                       name={'عنوان فرم'} placeholder={'عنوان فرم را وارد نمایید'}/>
                                        ...
                                        <Row>
                                            <Col>
                                                ...
                                                <Input value={this.state.AfterMessage} type={'textarea'}
                                                       id={'afterMsg'}
                                            ...
                                            >
                                                <Form.Group controlId="onlyMe">
                                                    <Form.Check type="checkbox" label="انحصارا این فرم مخصوص شما باشد"
                                        ...
                                        <Row>
                                            ...
                                            <Col md={7}>
                                                ...
                                                <Card>
                                                    <Card.Body>
                                                        {this.state.elements && <h5>لیست فیلد های تعریف شده </h5>}
                                                        {(!this.state.elements || !this.state.elements.length) &&
                                                        <h5>از منوی ابزار ابتدا انتخاب نمایید</h5>}

                                                        {this.state.elements &&
                                                        <FormRenderer elements={this.state.elements} editable={true}/>}


                                                        {this.state.elementsError && <small
                                                            style={{color: 'darkred'}}>{this.state.elementsError}</small>}
                ...
                }} title={"ویرایش ورودی های فرم "} onSave={() => {
    ...
    save() {
        ...
        if (this.validateInputSubElements() === false) {
            this.setState({elementsError: 'برای چک باکس ها و ورودی های انتخاب دار ، باید مقادیر تعریف نمایید'})
            return;
    ...
    render() {
        return (
            <div className={'toolsMenuFormCreator'}>
                ...
                <FormElement onClick={() => this.select('input')} id={'addElementInput'} >
                    <input/>

                </FormElement>

                <hr/>
                <FormElement onClick={() => this.select('textarea')} id={'addElementTextArea'}>
                    <textarea/>

                </FormElement>
                <hr/>
                <FormElement onClick={() => this.select('checkbox')} id={'addElementCheckBox'}>
                    <input type='checkbox'/>
                </FormElement>

                <hr/>

                <FormElement onClick={() => this.select('radio')} id={'addElementRadio'}>
                    <input type='radio'/>
                </FormElement>
...
const FormElement = (props) => {
    return (<div className={'fillerHolder'} id={props.id} onClick={() => {
        props.onClick()
    }}>
...
const FormRendererSingleElement = (props) => {
    return (<div className={'FormRendererSingleElement'}>
                ...
                <Row className={'fullWidth'}>
                    <Col md={2}>
                        <div style={{float: 'left'}}>
                            ...
                            <Button onClick={() => {
                                ...
                                CurrentUserInfo.FormCreatorPage.DeleteElement(props.el, props.j)
                    ...
                    <Col>
                        <div>
                            ...
                            {props.el.Name && <><label><span>عنوان فیلد :</span>{props.el.Name}</label><br/></>}

                            {props.children}

                            {props.el.Help && <small><span>متن راهنما :</span>{props.el.Help}</small>}
                        </div>
                    </Col>
                    <Col md={1}>
                        {props.editable && <Button className={'editElement'} onClick={() => {


                            CurrentUserInfo.selectedElementIndex = props.j;
                            CurrentUserInfo.FormCreatorPage.setState({showModal: true})
                ...
                this.props.elements.map((el, i, arr) => {
                    ...
                    if (el.type === 'input') {
                        return (
                            ...
                            <FormRendererSingleElement el={el} j={i} editable={this.props.editable}>

                                <Input readonly={!this.props.editable ? 'readonly' : null} value={el.Value}
                                       onChange={(e) => {
                    ...
                    if (el.type === 'textarea') {
                        return (
                            <FormRendererSingleElement el={el} j={i} editable={this.props.editable}> <textarea
                                readonly={!this.props.editable ? 'readonly' : null} className={'form-control'}
                                value={el.Value}

                                onChange={(e) => {
                                    el.Value = e.target.value;
                                }}></textarea></FormRendererSingleElement>
...
export class CreatedForms extends Component {
    ...
    render() {
        return (
            <div>
                {(!this.state.formList) &&
                <p>در حال خواندن فرم های تعریف شده</p>
                }
                <ListGroup className={'listGroup'}>
                    ...
                    <ListGroup.Item className={' text-primary'}>
                        ...
                        <a className={'pointer  floatRight  text-secondary '}>
                            ویرایش
                        </a>

                        <a className={'pointer  floatLeft  text-info '} title={'نمایش اطلاعات وارد شده'}>
                            اطلاعات
                        </a>
                    ...
                    this.state.formList.map((el, i, arr) => {
                        ...
                        return (<>
                            ...
                            <ListGroup.Item   key={i}  className={' text-primary'} onClick={() => {
                                this.select(el);
                            }}>
                                ...
                                <a className={'pointer  floatRight  text-secondary '} onClick={() => {
                                ...
                                <a className={'pointer  floatLeft  text-info '} title={'نمایش اطلاعات وارد شده'}
                                   onClick={() => {
                                       ...
                                       CurrentUserInfo.LayoutPage.showMsg('در حال خواندن اطلاعات ')
...
function showSubElements(el, editable) {
    ...
    return el.SubElements.map((subEl, j, arrr) => {
        ...
        return (<Row key={subEl.Tmp} dir={'rtl'}>
...
class EditElementForm extends Component {
    render() {
        ...
        if (CurrentUserInfo.selectedElementIndex == null || CurrentUserInfo.selectedElementIndex == undefined) {
            return <p>هیچ المنتی انتخاب نشده است</p>
        }

        if (!CurrentUserInfo.FormCreatorPage || !CurrentUserInfo.FormCreatorPage.state ||
        ...
        return (
            <div className={'editForm'}>
                ...
                <Input value={CurrentUserInfo.FormCreatorPage.state.elements[CurrentUserInfo.selectedElementIndex].Name}
                       type={'text'}
                       id={'fieldTitle'}
                       onChange={(e) => {

                           CurrentUserInfo.FormCreatorPage.state.elements[CurrentUserInfo.selectedElementIndex].Name = e.target.value;
                       }}
                       name={'عنوان فیلد'} />

                <Input value={CurrentUserInfo.FormCreatorPage.state.elements[CurrentUserInfo.selectedElementIndex].Help}

                       id={'fieldHelp'}

                       type={'text'} onChange={(e) => {

                    CurrentUserInfo.FormCreatorPage.state.elements[CurrentUserInfo.selectedElementIndex].Help = e.target.value;
                }}
                ...
                <Input
                    value={CurrentUserInfo.FormCreatorPage.state.elements[CurrentUserInfo.selectedElementIndex].FieldName}

                    id={'fieldName'}

                    type={'text'} onChange={(e) => {

                    CurrentUserInfo.FormCreatorPage.state.elements[CurrentUserInfo.selectedElementIndex].FieldName = e.target.value;
                }}
                    
                    name={'نام یکتای فیلد'}/>


                {(CurrentUserInfo.FormCreatorPage.state.elements[CurrentUserInfo.selectedElementIndex].type === 'checkbox' ||
                    CurrentUserInfo.FormCreatorPage.state.elements[CurrentUserInfo.selectedElementIndex].type === 'radio')
                &&
                <>

                    <hr/>
                    <Button id={'addSubElements'} variant={'default'} onClick={() => {
                        this.addSubElement(CurrentUserInfo.FormCreatorPage.state.elements[CurrentUserInfo.selectedElementIndex])
                    }}> <span>+</span> <span>مقادیر قابل انتخاب</span> </Button>

                </>}

                {showSubElements(CurrentUserInfo.FormCreatorPage.state.elements[CurrentUserInfo.selectedElementIndex], true)}
