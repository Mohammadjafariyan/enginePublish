...
class CompaignLayout extends BaseCrudLayout {
    ...
    render() {
        return <>
            ...
            {this.state.showModal && <ConfirmModal body={<>
                <h4 className={'text-danger'}>تغییرات ذخیره نشده دارید </h4>
                <p className={'text-danger'}>در صورت ادامه تغییرات ذخیره نخواهند شد</p>
            ...
            <>
                ...
                <CompaignTable title={this.state.title} dataType={this.state.dataType}></CompaignTable>
            </>
            }
            ...
            <CompaignIndex onSaveClick={(form)=>{
