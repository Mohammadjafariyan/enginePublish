...
class CompaignTable extends Component {
    ...
    statusBody(row) {
        ...
        switch (row.Status){
            ...
            case 5:
                return <>
                    <span className={'text-danger'}>متوقف شده</span><br/>
                        ...
                        <Col>
                            <MyCard header={'جدول کمپین های تعریف شده'} >
                                ...
                                >
                                    ...
                                    <Column field="Status" header="وضعیت" body={this.statusBody}></Column>
                                    <Column field="ExecutionCount" header="تعداد اجرا"></Column>
                                    <Column field="LastChangeDateTimeStr" header="تاریخ آخرین تغییر" ></Column>
