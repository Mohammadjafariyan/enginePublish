            ...
            <div>
                ...
                <Editor style={{height: '320px'}}
                        ...
                        onTextChange={(e) => {
                            ...
                            this.setState({text1: e.htmlValue});
                ...
                <Row>
                    ...
                    <Col>
                        <Checkbox value={this.state.SendToChat} onChange={(e) => {
                ...
                <Row>
                    <Col>
                        ...
                        <Button variant={'info'} onClick={() => {
                            ...
                            if (_GetSelectedCompaign().Template.saveAsTemplate) {
                ...
                <MyConfirm parent={this} title={'لطفا یک نام برای این قالب اختصاص دهید'}
                    ...
                    <label>عنوان قالب </label><br/>
                    <InputText placeholder={'یک نام برای قالب نیاز است'} value={this.state.saveAsTemplateName}
                               onChange={(e) => {
